...
const surface = {
  ...
  './database/postgres': ['closeDrizzlePostgres', 'migrateDrizzlePostgres', 'openDrizzlePostgres', 'redactedPostgresUrl'],
  './database/sqlite': ['closeDrizzleSqlite', 'configureSqlite', 'openDrizzleSqlite', 'openSqliteClient'],
